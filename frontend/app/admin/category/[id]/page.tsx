...
import { getCategory, getCategories } from "@/app/api/fetchApi/adminApi";
                ...
                <div>
                    <div className="px-4">
                        ...
                        <select className="w-full bg-gray-100 border-none outline-none px-3 py-2 rounded appearance-none pr-8"
                                ...
                                onChange={(e) => setFormData(prev => ({ ...prev, parentCategoryId: Number(e.target.value) }))}
                            >
                                {categories.map(c => (
                                    <option key={c.id} value={c.parentCategoryId}>{c.name}</option>
                                ))}
                            </select>
                    ...
                    <div className="px-4 w-[520px]">
                        ...
                        <PhotoButton index={0} size={'xlarge'} imgSrc={category?.imageUrl || ''}/>
