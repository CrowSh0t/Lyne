...
import { getBrands, getCategories, getSizes } from "@/app/api/fetchApi/adminApi";
import { BrandDto, CategoryDto, SizeDto } from "@/app/types/dto";
                        ...
                        {categories.map(c => (
                            <div key={c.id} className="flex flex-row justify-between items-center w-full">
                                ...
                                <div className="flex items-center gap-x-4">
                                    ...
                                    <button className="hover:text-red-500" onClick={() => handleCategoriesDelete(c.id)}>
                                        <img src="/images/admin/icons/deleteIcon.png"  alt="Delete" width={18} height={20} />
                                    </button>
                                </div>
                            </div>
                        ...
                        {brands.map(b=> (
                            <div key={b.id} className="flex flex-row justify-between items-center w-full">
                                ...
                                <div className="flex items-center gap-x-4">
                                    ...
                                    <button className="hover:text-red-500" onClick={() => handleBrandsDelete(b.id)}>
                                        <img src="/images/admin/icons/deleteIcon.png" alt="Delete" width={18} height={20} />
                                    </button>
                                </div>
                            </div>
                        ...
                        {sizes.map(s=> (
                            <div key={s.id} className="flex flex-row justify-between items-center w-full">
                                ...
                                <div className="flex items-center gap-x-4">
                                    ...
                                    <button className="hover:text-red-500" onClick={() => handleSizesDelete(s.id)}>
                                        <img src="/images/admin/icons/deleteIcon.png" alt="Delete" width={18} height={20} />
                                    </button>
                                </div>
                            </div>
